...
from tg_bot import BOT_ID, AS_PTB, OWNER_ID as DEV_USERS
...
__help__ = """
Chatbot utilizes the Brainshop's API and allows Asuka to talk and provides a more interactive group chat experience.
...
AS_PTB.add_handler(CommandHandler("chatbot", chatbot_toggle,
                                        block=False))
AS_PTB.add_handler(
